sap.ui.define([
		...
		return BaseObject.extend("basf.salesorderissue.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias basf.salesorderissue.model.ListSelector
			 */
			 ...
			 * @return {basf.salesorderissue.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
